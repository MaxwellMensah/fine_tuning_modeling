...
def generate_fraud_data(num_records=500):
    ...
    for i in range(num_records):
        ...
        is_late_night = any(x in time for x in ["AM", "PM"]) and (
            "2" in time or "3" in time or "4" in time
        )
        ...
        if is_suspicious:
            reasoning = [
                ...
                "Step 3: Risk Assessment - The probability of account takeover or credit card fraud is elevated.",
            ...
            reasoning = [
                ...
                "Step 3: Risk Assessment - No indicators of fraud, velocity limits, or suspicious routing detected.",
